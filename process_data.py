...
def generate_vec(data_path,docs):
    ...
    for doc in docs:
        ...
        zp_candi_coref = {} # zp_index: [0,1,0,0,0]
        for zp_index in doc.zp2candi_dict:
            if len(doc.zp2candi_dict[zp_index]) > 0:
                ...
                for np_index in np_indexes:
                    ...
                    zp_candi_distance_dict[(zp_index,np_index)] = utils.get_bin(distance)
                    ...
                    if (this_np_real_sentence_num,this_np_real_start,this_np_real_end) in doc.np_dict:
                        ...
                        if this_zp:
                            if this_candi in this_zp.antecedent:
                                zp_candi_coref[zp_index][np_index] = 1
...
if __name__ == "__main__":
    ...
    cPickle.dump(train_generater, save_f, protocol=
